          ...
          <c:forEach items="${students}" var="student" >
			<tr>
                ...
                <td><a href="showFormForUpdate?studentId=${student.studentid}" class="btn btn-info btn-sm">Update</a>
                    <a href="delete?studentId=${student.studentid}" class="btn btn-danger btn-sm" onclick="if (!(confirm('Are you sure you want to delete this Student?'))) return false">Delete</a></td>
            </tr>
          </c:forEach>
        </tbody>
    </table>
